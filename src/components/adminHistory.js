...
const AdminHistory = () => {
    ...
    useEffect(() => {
        ...
        .then(res => {
            ...
            setHistorial(content.historial)
        })
    }, [])
    const addEvent = () => {
        setErrors([])
        ...
        if (title.length == 0 || description.length == 0){
            ...
            .then(res => {
                let obj = [...res.data][0]
                if ([...obj.historial].length > 0){
                    axios.post(`${baseURL}/api/editAboutContent/any/${1}`, {
                        historial: [
                            
                            {
                                id: [...obj.historial].length + 1,
                                titulo: title,
    ...
    const editEvent = (item) => {
        ...
        if (title.length == 0 || description.length == 0){
            ...
            .then(res => {
                let obj = [...res.data][0]
                let hist = [...obj?.historial]
                let newHist = hist.map((h) => {
                    if (h.id == item.id){
                        return {
                            id: item.id,
                            titulo: title,
        ...
        <div className="dashboardContainer" id='adminHomeContainer'>
            ...
            <section className='section'>
                    <div className='header'>
                        <HeaderLabel title='Acontecimentos'/>
                        <Dialog>
                            ...
                            <DialogContent style={{width: '100%', maxWidth: 1000, display: 'flex', flexDirection: 'column'}}>
                                ...
                                <div className='sectionForms'>
                                    <div className='form'>
                                        <div className='label'>Título do acontecimento</div>
                                    ...
                                    <div className='form'>
                                        <div className='label'>Data do acontecimento</div>
                                        <Popover>
                                        ...
                                        <div className='form'>
                                        <div className='label'>Descrição do acontecimento</div>
  ...
  <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
            ...
            .then(res => {
                ...
                .catch(err => {
                    ...
                    :<div style={{fontSize: 14, textAlign: 'center'}}>Nenhum acontecimento registrado. Adicione um.</div>
                    }
