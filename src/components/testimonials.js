...
Trabalho em hospitais, clínicas, centros de saúde.`,
                ...
                {[...item?.cursos].length >= 1 ? [...item?.cursos].slice(0, 3).map((course, index) => {
                    return (
                        <div className='courseContainer'>
                            ...
                            <div className='description'>{item?.info?.titulo}</div>
                        </div>
                    )
                }): 
         ...
         :['.', '.', '.'].map((item)=> {
            ...
            <section className='firstCont'>
                ...
                <Skeleton className='videoCont'/>}
                    <div className='info'>
                        {<Skeleton style={{background: '#e3e3e3', margin: 0, padding: 0, marginTop: 5}} className='title' />}
                        <div className='profile'>
                            <div className='profileInfo'>
                                <div style={{background: '#eeeeee'}} className='profileImageContainer'/>
                                {<Skeleton style={{background: '#e3e3e3', margin: 0, padding: 0, height: 14, width: 150}}count={2} className='profileName' />}
                            </div>
                            {<Skeleton style={{background: '#e3e3e3', margin: 0, padding: 0, height: 40, width: 100}} />}
                        </div>
                        {<div className='aboutCourse'><Skeleton style={{background: '#e3e3e3', margin: 0, padding: 0, height: 14, width: '100%'}} count={4} /></div>}
                    </div>
  ...
  <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"/>
        ...
        <div className='servicesControl1'>
            ...
            <div id='autoPlay1' className="autoplay-progress" slot="container-end">
