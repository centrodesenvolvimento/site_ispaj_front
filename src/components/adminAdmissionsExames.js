...
const AdminAdmissionsExames = () => {
    ...
    const addDocument = () => {
        ...
        if (title.length == 0 || !selectedDoc) {
            ...
            axios.post(`${baseURL}/api/editAdmissionsContent/exames/${2}`, {
    ...
    useEffect(() => {
        ...
        .then(res => {
            ...
            setDocuments(content.exames)
        })
    }, [])
    return (
        <div className="dashboardContainer" id='adminHomeContainer'>
            <div className="title">Exames de Acesso</div>
            
            <div className='first'>
            <section className='section'>
                    <div className='header'>
                        <HeaderLabel title='Exames de Acesso'/>
                        <Dialog>
                            ...
                            <DialogContent style={{width: '100%', maxWidth: 1000, display: 'flex', flexDirection: 'column'}}>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Adicionar tópicos</DialogDescription>

                                </DialogHeader>
                                <ScrollArea style={{height: '90vh', marginTop: 20}}>
                                    <div className='sectionForms'>
                                        <div className='form'>
                                            <div className='label'>Nome do curso</div>
                                            <input value={title} onChange={(e) => {
                                                setTitle(e.target.value)
                                            }} placeholder='Nome do curso...' className='loginInput'/>
                                        </div>
  ...
  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325"/>
                            ...
                            <DialogContent style={{width: '100%', maxWidth: 1000, display: 'flex', flexDirection: 'column'}}>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Editar tópicos</DialogDescription>
...
export default AdminAdmissionsExames