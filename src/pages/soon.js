    ...
    return (
        <div className="abtCont">
            ...
            <div className="soonContainer">
                <div className="soonInfo">
                    <div className="title">Brevemente Disponível</div>
                    <div>
                    <div className="description">Enquanto isso, siga-nos em nossas contas sociais para se manter actualizado</div>
